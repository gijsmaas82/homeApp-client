  ...
  render() {
    return (
      <div className="applegame">
        <div className="applegame__header">
          <h1> Apple Picking </h1>
        </div>
        {this.props.gameOver ? 
          ...
          <Stage  width={window.innerWidth - 20} height={window.innerHeight - 200}>
            <Layer>
              ...
              {this.props.droppedApples.map(apple => {
                ...
                fill="#E91E1E"
                fill-opacity="0.75"
                data="M23.5 16.5L27 11.5L32 13C26.6667 20.6667 18.2 34.3 27 27.5C35.8 20.7 43.3333 24.6667 46 27.5C47 38.8333 46.4 61.1 36 59.5C23 57.5 22.5 58 13.5 59.5C4.5 61 -3 33 3.5 27.5C8.7 23.1 16.3333 25.6667 19.5 27.5L23.5 16.5ZM23.5 16.5L20 14M20 14C21.5 11.5 21.9 5.6 11.5 2C1.1 -1.6 8.5 8.5 13.5 14H20Z" 
                stroke="black"
              />
              })}
